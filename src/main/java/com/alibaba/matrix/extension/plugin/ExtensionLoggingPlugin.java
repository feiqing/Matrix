...
public class ExtensionLoggingPlugin implements ExtensionPlugin {
    ...
    public Object invoke(ExtensionInvocation invocation) throws Exception {
        ...
        try {
            ...
            if (except == null) {
                extensionLogger.info("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|", group, extType, extPoint, router, code, type, instance, getArgs(args), getResult(result), rt);
            } else {
                extensionLogger.error("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|", group, extType, extPoint, router, code, type, instance, getArgs(args), getResult(result), rt, except);
            }
        }
    }
